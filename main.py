...
with col2:
    ...
    st.image(profile)
    st.write("---")
    st.markdown("<span style='text-align:center; font-size:18pt; color:gray;'><b>Personal Info</b></span>",unsafe_allow_html=True)
    st.markdown('<a href="https://app.daily.dev/blankscreenEXE"><img src="https://api.daily.dev/devcards/736b8e5f6ab640779df15513b8c0e2f6.png?r=u7s" width="200" alt="Muhammad Hammad Hassan\'s Dev Card"/></a>',unsafe_allow_html=True)
